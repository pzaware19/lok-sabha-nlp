...
```{=html}
<div class="stat-row">
  <div class="stat"><div class="stat-num">4,315</div><div class="stat-label">LS starred questions</div></div>
...
## Linguistic Register: Hindi Framing vs English vs Regional {#language}
...
![% of starred question titles containing at least one transliterated Hindi policy term, by party. Connected dots show the same party in LS (blue) vs RS (gold). Parties to the right use more Hindi framing.](output/figures/compare_hindi_intensity.png){width=90%}

::: {.callout-note}
## What the Hindi intensity comparison shows
...
![Regional geographic markers in RS question titles, by party. Only RS bars are shown because southern parties (DMK, AIADMK, TDP) have too few LS matched questions for comparison. The markers capture Tamil, Telugu, and Bengali geographic place names appearing in question titles.](output/figures/compare_regional_markers.png){width=95%}
...
![Linguistic register summary: % of questions with Hindi policy terms (left) and regional geographic markers (right), by party and house. A richer blue = higher prevalence.](output/figures/compare_lang_heatmap.png){width=90%}
